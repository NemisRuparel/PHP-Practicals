...
<body>
    <div class="container">
        <h1>1. Abstract Class (Animal)</h1>
        <h3>Method: makeSound()</h3>
        <p>Defined inside an abstract class. Any child class must define makeSound().<br></p>

        <h1>2. Child Classes</h1>
    ...
    echo "<h2>Abstract Class Implementation Output</h2><hr>";
