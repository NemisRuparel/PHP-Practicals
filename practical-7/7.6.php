...
<body>
    <div class="container">
        <h1>1. GrandParent Class (GrandParentClass)</h1>
    ...
    class GrandParentClass
    {
        public function displayMessage()
        {
            ...
            echo "<h2>Grand Parent Class:</h2><hr>";
        }
    }
    ...
    class ParentClass extends GrandParentClass
    {
        public function displayMessage()
        {
            ...
            echo "<h2>Parent Class Method Calling GrandParent Class</h2>";
            echo "</div>";

        }

        public function displayMessage1()
        {
            echo "<div class='half1'>";
    ...
    class ChildClass extends ParentClass
    {
        public function displayMessage()
        {
            parent::displayMessage1();
            echo "<h2>Child Class Method Calling Parent Class</h2>";
            echo "</div>";
